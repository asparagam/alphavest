...
export const AICopilot: React.FC = () => {
  ...
  return (
    <div className="space-y-8">
      <div className="glass-panel p-6 border-ai-500/30">
        ...
        <h1 className="type-heading-xl text-slate-100">AI Copilot Strategic Assistant</h1>
        ...
        <div className="flex flex-col h-[520px]">
          <div className="flex-1 overflow-y-auto space-y-4 pr-2">
            {messages.map((m) => (
              ...
              >
                {m.sender === 'ai' && (
                  <div className="w-8 h-8 rounded-xl bg-ai-600/20 border border-ai-500/40 text-ai-400 flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            {isTyping && (
              <div className="flex gap-3 items-center text-slate-400 text-xs py-2">
                <div className="w-8 h-8 rounded-xl bg-ai-600/20 text-ai-400 flex items-center justify-center">
          ...
          <div className="py-3 flex gap-2 overflow-x-auto scroll-hide border-t border-dark-border/60">
            {quickPrompts.map((qp, i) => (
              <button
                key={i}
                onClick={() => handleSend(qp.query)}
                className="px-3 py-1.5 rounded-xl bg-dark-card border border-dark-border hover:border-ai-500/40 text-xs text-slate-300 hover:text-white whitespace-nowrap transition-colors flex items-center gap-1.5 cursor-pointer"
              >
